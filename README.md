...
- **Human Calibration:** We provide evidence of how well our LLM judge agrees with a human evaluator using Cohen's Kappa ($\kappa$). (Run `python3 -m src.llm_judge_calibration` to see the scores).
